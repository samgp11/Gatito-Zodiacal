...
import { CardContainer, CatImage, CatTitle, CatDescription, CatTemperament } from "./CatCard.styles";

export default function CatCard({ cat, maxWidth }) {
    ...
    <CardContainer maxWidth={maxWidth}>
      ...
      {breed ? (
        <>
          ...
          <CatTemperament><strong>Temperamento:</strong> {breed.temperament}</CatTemperament>
        </>
      ) : (
        <CatDescription>
